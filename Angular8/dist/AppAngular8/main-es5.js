...
var PessoasComponent = /** @class */ (function () {
    function PessoasComponent(pessoasService) {
    ...
    PessoasComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pessoasService.pegartodos().subscribe(function (resultado) {
            _this.pessoas = resultado;
        });
    };
    PessoasComponent.prototype.ExibirFormularioCadastro = function () {
    ...
    PessoasComponent.prototype.EnviarFormulario = function () {
        var _this = this;
        var pessoa = this.formulario.value;
        this.pessoasService.salvarPessoa(pessoa).subscribe(function (resultado) {
            _this.visibilidadeTabela = true;
            _this.visibilidadeFormulario = false;
            alert("pessoa inserida com sucesso");
            _this.pessoasService.pegartodos().subscribe(function (registros) {
                _this.pessoas = registros;
            });
        });
    };
    ;
    PessoasComponent.prototype.Voltar = function () {
        this.visibilidadeTabela = true;
        this.visibilidadeFormulario = false;
    };
    PessoasComponent.ctorParameters = function () { return [
...
var PessoasService = /** @class */ (function () {
    ...
    PessoasService.prototype.pegartodos = function () {
        return this.http.get(this.url);
    };
    PessoasService.prototype.pegarPeloId = function (pessoaId) {
        var apiUrl = this.url + "/" + pessoaId;
        return this.http.get(apiUrl);
    };
    PessoasService.prototype.salvarPessoa = function (pessoa) {
        return this.http.post(this.url, pessoa, this.httpOptions);
    };
    PessoasService.prototype.atualizarPessoa = function (pessoa) {
        return this.http.put(this.url, pessoa, this.httpOptions);
    };
    PessoasService.prototype.excluirPessoa = function (pessoaId) {
        var apiUrl = this.url + "/" + pessoaId;
        return this.http.delete(apiUrl, this.httpOptions);
    };
    PessoasService.ctorParameters = function () { return [
